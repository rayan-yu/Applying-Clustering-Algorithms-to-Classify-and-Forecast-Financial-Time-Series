...
data_folder = 'SP500_2018_daily' #'SP500_2018_5min' # 'SP500_2018_30min', 'SP500_2018_daily'
...
while i < len(sp_csv):
    ...
    df2 = pd.read_csv(data_pathfolder + '/' + sp_csv[i], usecols=[0, 1, 5], dtype={0:'str',1:'int64'}, skipfooter=1, engine='python')
    ...
    df2 = pd.DataFrame(price_series) # make the time series into a dataframe, one stock a row
...
# df_tr = df.T
# df_tr.index.name = "Symbol"
# df_tr.to_csv(path_proj + data_folder + "_ticker_rows-demo.csv") # ticker as rows
